...
export default function DashboardClient() {
  ...
  const handleLogout = () => {
    // Client-side attempt to clear cookie (works if not HttpOnly)
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-5">
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1 mt-2">
                  <li>
                    <a href="/profile" className="text-blue-600 hover:underline">Manage Profile</a>
                  </li>
                  <li>
                    <a href="/reports" className="text-blue-600 hover:underline">View Reports</a>
                  </li>
                  <li>
                    <a href="/api/auth/logout" className="text-blue-600 hover:underline">Log Out</a>
                  </li>
                </ul>
              </div>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-5">
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Exclusive Video</h3>
              <p className="text-gray-600 mb-4">Watch our new AWS S3 hosted video:</p>
